...
:::definition "DEF-LAW" (parent := "foundations") (lean := "StochasticToDeterministicLatents.IsPMF") (uses := "") (tags := "definition")
A law on finite alphabets $`\alpha` and $`\beta` is a nonnegative function $`p : \alpha\times\beta\to\mathbb R` with total mass one.
:::

:::definition "DEF-INFO" (parent := "foundations") (lean := "StochasticToDeterministicLatents.entropy, StochasticToDeterministicLatents.entropyOf, StochasticToDeterministicLatents.condEntropy, StochasticToDeterministicLatents.mutualInfo, StochasticToDeterministicLatents.condMutualInfo") (uses := "DEF-LAW") (tags := "definition")
...
:::definition "DEF-LATENT" (parent := "foundations") (lean := "StochasticToDeterministicLatents.Latent") (uses := "DEF-LAW") (tags := "definition")
...
:::definition "DEF-SCORE" (parent := "foundations") (lean := "StochasticToDeterministicLatents.Latent.score") (uses := "DEF-LATENT, DEF-INFO") (tags := "definition")
The score of a supplied latent is $`\operatorname{score}_p(L)=I(X;Y\mid L)+I(L;X\mid Y)+I(L;Y\mid X)`.
:::

:::definition "DEF-TAU" (parent := "foundations") (lean := "StochasticToDeterministicLatents.tau") (uses := "DEF-SCORE") (tags := "definition")
...
:::definition "DEF-CODE" (parent := "foundations") (lean := "StochasticToDeterministicLatents.Code, StochasticToDeterministicLatents.constantCode") (uses := "DEF-LAW") (tags := "definition")
...
:::definition "DEF-DETSCORE" (parent := "foundations") (lean := "StochasticToDeterministicLatents.detScore, StochasticToDeterministicLatents.T") (uses := "DEF-CODE, DEF-INFO") (tags := "definition")
...
:::definition "DEF-W3" (parent := "foundations") (lean := "StochasticToDeterministicLatents.w3Cost, StochasticToDeterministicLatents.w3, StochasticToDeterministicLatents.scoreRebate") (uses := "DEF-LATENT, DEF-CODE, DEF-INFO") (tags := "definition")
